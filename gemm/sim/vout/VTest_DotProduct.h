...
VL_MODULE(VTest_DotProduct) {
  public:
	...
	VL_SIG8(__PVT__m_0__DOT__rC,0,0);
	VL_SIG8(__PVT__m_1__DOT__rA,7,0);
	VL_SIG8(__PVT__m_1__DOT__rC,0,0);
	VL_SIG8(__PVT__m_2__DOT__rA,7,0);
	VL_SIG8(__PVT__m_2__DOT__rC,0,0);
	VL_SIG8(__PVT__m_3__DOT__rA,7,0);
	VL_SIG8(__PVT__m_3__DOT__rC,0,0);
	VL_SIG8(__PVT__m_4__DOT__rA,7,0);
	VL_SIG8(__PVT__m_4__DOT__rC,0,0);
	VL_SIG8(__PVT__m_5__DOT__rA,7,0);
	VL_SIG8(__PVT__m_5__DOT__rC,0,0);
	VL_SIG8(__PVT__m_6__DOT__rA,7,0);
	VL_SIG8(__PVT__m_6__DOT__rC,0,0);
	VL_SIG8(__PVT__m_7__DOT__rA,7,0);
	VL_SIG8(__PVT__m_7__DOT__rC,0,0);
	VL_SIG8(__PVT__m_8__DOT__rA,7,0);
	VL_SIG8(__PVT__m_8__DOT__rC,0,0);
	VL_SIG8(__PVT__m_9__DOT__rA,7,0);
	VL_SIG8(__PVT__m_9__DOT__rC,0,0);
	VL_SIG8(__PVT__m_10__DOT__rA,7,0);
	VL_SIG8(__PVT__m_10__DOT__rC,0,0);
	VL_SIG8(__PVT__m_11__DOT__rA,7,0);
	VL_SIG8(__PVT__m_11__DOT__rC,0,0);
	VL_SIG8(__PVT__m_12__DOT__rA,7,0);
	VL_SIG8(__PVT__m_12__DOT__rC,0,0);
	VL_SIG8(__PVT__m_13__DOT__rA,7,0);
	VL_SIG8(__PVT__m_13__DOT__rC,0,0);
	VL_SIG8(__PVT__m_14__DOT__rA,7,0);
	VL_SIG8(__PVT__m_14__DOT__rC,0,0);
	VL_SIG8(__PVT__m_15__DOT__rA,7,0);
	VL_SIG8(__PVT__m_15__DOT__rC,0,0);
	...
	VL_SIG16(__PVT__a_0_0__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_1__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_2__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_3__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_4__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_5__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_6__DOT__rB,8,0);
	VL_SIG16(__PVT__a_0_7__DOT__rB,8,0);
	VL_SIG16(__PVT__a_1_0__DOT__rB,9,0);
	VL_SIG16(__PVT__a_1_1__DOT__rB,9,0);
	VL_SIG16(__PVT__a_1_2__DOT__rB,9,0);
	VL_SIG16(__PVT__a_1_3__DOT__rB,9,0);
	VL_SIG16(__PVT__a_2_0__DOT__rB,10,0);
	VL_SIG16(__PVT__a_2_1__DOT__rB,10,0);
	VL_SIG16(__PVT__a_3_0__DOT__rB,11,0);
  ...
  public:
    void _initial__TOP__Test__DOT__mvcore__DOT__dot_0__33(VTest__Syms* __restrict vlSymsp) VL_ATTR_COLD;
