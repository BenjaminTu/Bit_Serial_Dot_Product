...
/** Register File.
  ...
  *  Cycle counter           | 0x04
  *  Vector length           | 0x08
  *  Input1 pointer lsb      | 0x0c
  *  Input1 pointer msb      | 0x10
  *  Input2 pointer lsb      | 0x14
  *  Input2 pointer msb      | 0x18
  *  Input3 pointer lsb      | 0x1c
  *  Input3 pointer msb      | 0x20
  *  Output pointer lsb      | 0x24
  *  Output pointer msb      | 0x28
